		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#student64saptrainingmodularization-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"student64saptrainingmodularization-display": {
								"semanticObject": "student64saptrainingmodularization",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=student64.sap.training.modularization",
									"url": sap.ui.require.toUrl("student64/sap/training/modularization")
								}
							}
						}
					}
